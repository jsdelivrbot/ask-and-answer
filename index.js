...
function getAnswer(req, res) {
	...
	var sql = 'SELECT answer.id, answer.content, answer.user_id, answer.question_id FROM answer INNER JOIN "user" ON answer.user_id = "user".id WHERE ($1::int IS NULL OR answer.id = $1::int) AND ($2::int IS NULL OR answer.question_id = 2::int)';
