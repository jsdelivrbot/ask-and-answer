...
function getAnswer(req, res) {
	...
	var sql = 'SELECT answer.id, answer.content, answer.user_id, answer.question_id FROM answer INNER JOIN "user" AS us ON answer.user_id = us.id WHERE ($1::int IS NULL OR id = $1::int) AND ($2::int IS NULL OR question_id = 2::int)';
